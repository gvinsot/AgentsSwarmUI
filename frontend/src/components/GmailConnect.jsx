    ...
    return (
      <div className="p-3 bg-dark-800/30 rounded-lg border border-dark-700/30">
        ...
        <p className="text-xs text-dark-500">
          Set <code className="text-dark-400">GMAIL_CLIENT_ID</code>, <code className="text-dark-400">GMAIL_CLIENT_SECRET</code>, and <code className="text-dark-400">GMAIL_REDIRECT_URI</code> environment variables to enable.
        </p>
      </div>
    );
  }
