  ...
  router.put('/:id', requireRole('admin'), async (req, res) => {
    try {
      ...
      const config = {
        ...
        managesContext: req.body.managesContext !== undefined ? !!req.body.managesContext : (existing.managesContext || false),
        supportsImages: req.body.supportsImages !== undefined ? !!req.body.supportsImages : (existing.supportsImages || false),
