...
- Check agent status to monitor task progress and verify completion.`
  ...
  },
  {
    "id": "skill-gdrive",
    "name": "Google Drive",
    "description": "Browse, search, read, upload, share, and manage files in Google Drive (per-agent OAuth)",
    "category": "general",
    "icon": "🗂️",
    "builtin": true,
    "mcpServerIds": [
